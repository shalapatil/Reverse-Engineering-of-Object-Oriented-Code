 ...
 * 
 */
public class classEditor extends Applet implements ActionListener,
		classMeasurments {
	...
	void drawLine(int id, int class_obj_id, Graphics g,
		...
		System.out
				.println("Association between " + id + " and " + class_obj_id);
		...
		default:
			// final case for handling anything
	...
	private void defaultCase(Graphics g, int id_diff, int id1, int id2,
		...
		if (id1 % 2 == 0 && id2 % 2 == 1) // 1st class is at botton- botton to
											// up
		{
			System.out.println("I am here..");

			if (true)// 1st class is on LHS
			{
		...
		else if (id1 % 2 == 1 && id2 % 2 == 1)// top to top
		{
			int shortLine = (id1 / 2) * smallLineDist + 2;
	...
	private void case1(int id1, int id2, Graphics g,
		...
		if (id1 % 2 == 1) // /odd case - 1st class at 1st level
		{
			x1 = (((id1 + 1) / 2) - 1) * (classWidth + horizontalSpace)
					+ startClassX + classWidth / 2;
			y1 = startClassY + classHeight;
